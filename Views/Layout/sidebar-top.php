        ...
        <a class="nav-link <?= ($active == "users") ? "active" : ""; ?> ?>" href="<?= base_url() ?>user/index">
            <span class="nav-icon">
                <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-people-fill" viewBox="0 0 16 16">
                    <path d="M8 0a4 4 0 0 1 3.464 6.001 4 4 0 1 1-6.928 0A4 4 0 0 1 8 0zm0 2a2 2 0 1 0 0 4 2 2 0 0 0 0-4zm0 9c-2.333 0-7 1.17-7 3.5V14h14v.5c0-2.33-4.667-3.5-7-3.5z" />
                </svg>
            </span>
